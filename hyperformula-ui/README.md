...
When importing it: keep the scope it publishes under today, give it an `.nvmrc` saying `22`, and add an `AGENTS.md` with a `CLAUDE.md` symlink beside it. See [`dev-docs/STRUCTURE.md`](../dev-docs/STRUCTURE.md#what-the-move-still-owes).
