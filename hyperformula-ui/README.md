...
When importing it: keep the scope it publishes under today, give it an `.nvmrc` saying `22` and a `CHANGELOG.md` of its own, and add an `AGENTS.md` with a `CLAUDE.md` symlink beside it. See [`dev-docs/MONOREPO.md`](../dev-docs/MONOREPO.md).
