...
- [ ] I have signed the [Contributor License Agreement](https://cla-gate.handsontable-sandbox.workers.dev/sign) — one signature covers both HyperFormula and Handsontable; the `cla/signed` check on this PR confirms it.
