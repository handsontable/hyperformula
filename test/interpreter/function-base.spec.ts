...
describe('function BASE', () => {
  it('should return error when argument of wrong type', async() => {
...
const engine = await HyperFormula.buildFromArray([
  ...
  it('should respect third argument and fill with zeros', async() => {
const engine = await HyperFormula.buildFromArray([
      ['=BASE(2, 8, 3)'],
      ['=BASE(94862, "33", 16)'],
    ])
  ...
  it('should return result as is if padding shorter than result', async() => {
const engine = await HyperFormula.buildFromArray([
      ['=BASE(123, 2, 5)'],
    ])
...
const engine = await HyperFormula.buildFromArray([
  ...
  it('should allow base from 2 to 36', async() => {
const engine = await HyperFormula.buildFromArray([
      ['=BASE(2, 1)'],
      ['=BASE(2, 2)'],
      ['=BASE(2, 36)'],
