...
describe('Function NPER', () => {
  ...
  it('should calculate the correct value with correct arguments and defaults', () => {
    ...
    expect(engine.getCellValue(adr('C2'))).toEqual(detailedError(ErrorType.NUM, 'Infinite value.'))
    expect(engine.getCellValue(adr('D2'))).toEqual(detailedError(ErrorType.NUM, 'Infinite value.'))
    expect(engine.getCellValue(adr('A3'))).toEqual(detailedError(ErrorType.NUM, 'Infinite value.'))
    ...
    expect(engine.getCellValue(adr('A6'))).toEqual(detailedError(ErrorType.NUM, 'Infinite value.'))
