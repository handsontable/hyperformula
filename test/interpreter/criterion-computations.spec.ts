...
describe( 'big test', () => {
  it('regex example', () => {
    const formulas = [
      ["w b 2r2 x", 8.89999999999418, , "w", "[^hrcsx]*w ?f?", "=COUNTIF(A1:A49,E1)", "=SUMIF($A$1:$A$49,E1,$B$1:$B$49)"],
      ["w F", 2.20000000001164, , "w b", "[^hrcsx]*w*b ?f?", "=COUNTIF(A2:A50,E2)", "=SUMIF($A$1:$A$49,E2,$B$1:$B$49)"],
      ["w", 2.19999999999709, , "r &/or c", "[^hsx]*[cr][^hsx]*", "=COUNTIF(A3:A51,E3)", "=SUMIF($A$1:$A$49,E3,$B$1:$B$49)"],
      ["w", 2.09999999999127, , "1h", ".*1h[^sx]*", "=COUNTIF(A4:A52,E4)", "=SUMIF($A$1:$A$49,E4,$B$1:$B$49)"],
      ["w b 1c2 x", 2.40000000000873, , "2h", ".*2h[^sx]*", "=COUNTIF(A5:A53,E5)", "=SUMIF($A$1:$A$49,E5,$B$1:$B$49)"],
      ["w 1c1 F", 4.39999999999418, , "1h 1s", ".*1h.*1s.*[^x]", "=COUNTIF(A9:A57,E6)", "=SUMIF($A$1:$A$49,E6,$B$1:$B$49)"],
      ["w b F", 2.30000000000291, , "2h 1s", ".*2h.*1s.*[^x]", "=COUNTIF(A11:A59,E7)", "=SUMIF($A$1:$A$49,E7,$B$1:$B$49)"],
      ["w F", 2.30000000000291, , "3h 1s", ".*3h.*1s.*[^x]", "=COUNTIF(A12:A60,E8)", "=SUMIF($A$1:$A$49,E8,$B$1:$B$49)"],
      ["w F", 2.09999999999127, , "2h 2s", ".*2h.*2s.*[^x]", "=COUNTIF(A15:A63,E9)", "=SUMIF($A$1:$A$49,E9,$B$1:$B$49)"],
      ["w F b", 2.20000000001164, , "3h 2s", ".*3h.*2s.*[^x]", "=COUNTIF(A16:A64,E10)", "=SUMIF($A$1:$A$49,E10,$B$1:$B$49)"],
      ["w", 2.29999999998836, , "4h 2s", ".*4h.*2s.*[^x]", "=COUNTIF(A19:A67,E11)", "=SUMIF($A$1:$A$49,E11,$B$1:$B$49)"],
      ["w 2r2", 3.30000000000291, , "5h 2s", ".*5h.*2s.*[^x]", "=COUNTIF(A20:A68,E12)", "=SUMIF($A$1:$A$49,E12,$B$1:$B$49)"],
      ["w  1r3", 2.30000000000291, , "4h 3s", ".*4h.*3s.*[^x]", "=COUNTIF(A22:A70,E13)", "=SUMIF($A$1:$A$49,E13,$B$1:$B$49)"],
      ["wF", 3.39999999999418, , "5h 3s", ".*5h.*3s.*[^x]", "=COUNTIF(A23:A71,E14)", "=SUMIF($A$1:$A$49,E14,$B$1:$B$49)"],
      ["wF", 3.20000000001164, , "5h 4s", ".*5h.*4s.*[^x]", "=COUNTIF(A24:A72,E15)", "=SUMIF($A$1:$A$49,E15,$B$1:$B$49)"],
      ["wF", 3.29999999998836, , "6h 4s", ".*6h.*4s.*[^x]", "=COUNTIF(A26:A74,E16)", "=SUMIF($A$1:$A$49,E16,$B$1:$B$49)"],
      ["wF", 3.30000000000291, , "7h 4s", ".*7h.*4s.*[^x]", "=COUNTIF(A28:A76,E17)", "=SUMIF($A$1:$A$49,E17,$B$1:$B$49)"],
      ["wF", 3.30000000000291, , "7h 5s", ".*7h.*5s.*[^x]", "=COUNTIF(A29:A77,E18)", "=SUMIF($A$1:$A$49,E18,$B$1:$B$49)"],
      ["w F 2r3", 5.60000000000582, , "9h 9s", ".*9h.*9s.*[^x]", "=COUNTIF(A30:A78,E19)", "=SUMIF($A$1:$A$49,E19,$B$1:$B$49)"],
      ["w 2r1", 3.29999999998836, , "x", ".*x.*", "=COUNTIF(A1:A49,E20)", "=SUMIF($A$1:$A$49,E20,$B$1:$B$49)"],
      ["w F 2r1", 4.5, , , , ,],
