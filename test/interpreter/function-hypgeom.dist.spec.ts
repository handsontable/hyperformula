...
describe('Function HYPGEOM.DIST', () => {
  ...
  it('should return error for arguments of wrong type', () => {
    const engine = HyperFormula.buildFromArray([
      ['=HYPGEOM.DIST("foo", 2, 3, 4, 5, TRUE())'],
      ['=HYPGEOM.DIST(1, "baz", 3, 4, 5, TRUE())'],
      ['=HYPGEOM.DIST(1, 2, "baz", 4, 5, TRUE())'],
      ['=HYPGEOM.DIST(1, 2, 3, "baz", 5, TRUE())'],
      ['=HYPGEOM.DIST(1, 2, 3, 4, "baz", TRUE())'],
      ['=HYPGEOM.DIST(1, 1, 1, 1, 1, "abcd")'],
    ])
  ...
  it('should work as cdf', () => {
    const engine = HyperFormula.buildFromArray([
      ['=HYPGEOM.DIST(1, 1, 0.1, TRUE())'],
      ['=HYPGEOM.DIST(10, 20, 0.7, TRUE())'],
    ])
