...
describe('Function SUBSTITUTE', () => {
  it('should take three or four parameters', async() => {
const engine = await HyperFormula.buildFromArray([
  ...
  it('should substitute new text for all occurrences of old text in a string', async() => {
const engine = await HyperFormula.buildFromArray([
      ['=SUBSTITUTE("foo", "f", "bb")'],
  ...
  it('should substitute new text for nth occurrence of a string', async() => {
const engine = await HyperFormula.buildFromArray([
...
const engine = await HyperFormula.buildFromArray([
  ...
  it('should return value when last argument is less than one', async() => {
const engine = await HyperFormula.buildFromArray([
