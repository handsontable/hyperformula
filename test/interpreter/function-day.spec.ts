...
const engine = await HyperFormula.buildFromArray([['=DAY("foo")', '=DAY("12/30/2018")', '=DAY(1, 2)', '=DAY()']])
...
const engine = await HyperFormula.buildFromArray([['=DAY(0)', '=DAY(2)', '=DAY(43465)']])
...
const engine = await HyperFormula.buildFromArray([['=DAY("31/12/1899")', '=DAY("01/01/1900")', '=DAY("31/12/2018")']])
