...
const engine = await HyperFormula.buildFromArray([['=INTERVAL("foo")', '=INTERVAL("12/30/2018")', '=INTERVAL(1, 2)', '=INTERVAL()']])
...
const engine = await HyperFormula.buildFromArray([['=INTERVAL(0)', '=INTERVAL(10000000)', '=INTERVAL(365.1)']])
...
const engine = await HyperFormula.buildFromArray([['=INTERVAL("31/12/1899")', '=INTERVAL("01/01/1900")', '=INTERVAL("31/12/2018")']])
