...
describe( 'Function DATE + leap years', () =>{
  it('should support nonleap year 2001 ', async() => {
    const config = new Config()
    const engine = await HyperFormula.buildFromArray([
      ['=DATE(2001,02,29)'],
    ], config)
  ...
  it('should support leap year 2016', async() => {
    const config = new Config()
    const engine = await HyperFormula.buildFromArray([
      ['=DATE(2016,02,29)'],
    ], config)
  ...
  it('should support leap year 1920', async() => {
    const config = new Config()
    const engine = await HyperFormula.buildFromArray([
      ['=DATE(1920,02,29)'],
    ], config)
  ...
  it('should support nonleap year 1900', async() => {
    const config = new Config()
    const engine = await HyperFormula.buildFromArray([
      ['=DATE(1900,02,29)'],
    ], config)
  ...
  it('should support nonleap year 1900 with excel compatibility', async() => {
  ...
  it('should support leap year 2400', async() => {
    const config = new Config()
    const engine = await HyperFormula.buildFromArray([
      ['=DATE(2400,02,29)'],
    ], config)
  ...
  it('should be leap1900 sensitive', async() => {
    const config = new Config({leapYear1900: true})
    const engine = await HyperFormula.buildFromArray([
      ['=DATE(10,03,03)'],
      ['=DATE(1800,02,28)'],
  ...
  it('different nullDate, leap1900 sensitive', async() => {
  ...
  it('should throw a error in the absence of arguments', async() => {
    const config = new Config()
    const engine = await HyperFormula.buildFromArray([
      ['=DATE()'],
    ], config)
