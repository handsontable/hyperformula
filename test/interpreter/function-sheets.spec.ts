...
describe('Function SHEETS', () => {
  ...
  it('should return VALUE for non-reference parameter', () => {
    ...
    expect(engine.getCellValue(adr('A1'))).toEqual(detailedError(ErrorType.VALUE, ErrorMessages.CellRef))
    expect(engine.getCellValue(adr('B1'))).toEqual(detailedError(ErrorType.VALUE, ErrorMessages.CellRef))
    expect(engine.getCellValue(adr('C1'))).toEqual(detailedError(ErrorType.VALUE, ErrorMessages.CellRef))
  })
