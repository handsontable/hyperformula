...
const engine = await HyperFormula.buildFromArray([
  ...
  it('works for larger ranges for mode 1',  async() => {
const engine = await HyperFormula.buildFromArray([
      [1, 10, 1, 1, 3, 7],
      [2, 5, 1, 1, 4, 8],
  ...
  it('works for larger ranges for mode 2',  async() => {
const engine = await HyperFormula.buildFromArray([
      [1, 10, 1, 1, 3, 7],
      [2, 5, 1, 1, 4, 8],
  ...
  it('works for larger ranges for mode 3',  async() => {
const engine = await HyperFormula.buildFromArray([
      [1, 10, 1, 1, 3, 7],
      [2, 5, 1, 1, 4, 8],
  ...
  it('validates range length for mode 1',  async() => {
const engine = await HyperFormula.buildFromArray([
      [1, 10, 1, 1, 3],
      [2, 5, 1, 1, 4, 8],
  ...
  it('works for distinct length ranges for mode 2',  async() => {
const engine = await HyperFormula.buildFromArray([
      [1, 10, 1, 1, 3],
      [2, 5, 1, 1, 4, 8],
  ...
  it('works for distinct length ranges for mode 3',  async() => {
const engine = await HyperFormula.buildFromArray([
      [1, 10, 1, 1, 3],
      [2, 5, 1, 1, 4, 8],
  ...
  it('doesnt do coercions, nonnumeric values are skipped for mode 1',  async() => {
const engine = await HyperFormula.buildFromArray([
      [1, 10, 1, 1, 3],
      [2, 5, null, 1, 4, 8],
      ['=T.TEST(A1:E1, A2:F2, 1, 1)']
  ...
  it('doesnt do coercions, nonnumeric values are skipped for mode 2',  async() => {
const engine = await HyperFormula.buildFromArray([
      [1, 10, 1, 1, 3, 7],
      [2, 5, null, 1, 4, 8],
  ...
  it('doesnt do coercions, nonnumeric values are skipped for mode 3',  async() => {
const engine = await HyperFormula.buildFromArray([
      [1, 10, 1, 1, 3, 7],
      [2, 5, null, 1, 4, 8],
