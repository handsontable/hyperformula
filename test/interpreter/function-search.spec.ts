...
const engine = await HyperFormula.buildFromArray([
  ...
  it('should return VALUE when wrong type of third parameter', async() => {
const engine = await HyperFormula.buildFromArray([
      ['=SEARCH("foo", "bar", "baz")'],
    ])
  ...
  it('should return VALUE if third parameter is not between 1 and text length', async() => {
const engine = await HyperFormula.buildFromArray([
      ['=SEARCH("foo", "bar", 0)'],
      ['=SEARCH("foo", "bar", -1)'],
      ['=SEARCH("foo", "bar", 4)'],
  ...
  it('should work with simple strings', async() => {
const engine = await HyperFormula.buildFromArray([
      ['=SEARCH("f", "foo")'],
      ['=SEARCH("o", "foo")'],
      ['=SEARCH("o", "foo", 3)'],
...
const engine = await HyperFormula.buildFromArray([
  ...
  it('should work with regular expressions', async() => {
const engine = await HyperFormula.buildFromArray([
      ['=SEARCH(".*f", "foobarbaz")'],
      ['=SEARCH("b.*b", "foobarbaz")'],
      ['=SEARCH("b.z", "foobarbaz")'],
