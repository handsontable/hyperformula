...
const engine = await HyperFormula.buildFromArray([['=SECOND("foo")', '=SECOND("12/30/2018")', '=SECOND(1, 2)', '=SECOND()']])
...
const engine = await HyperFormula.buildFromArray([['=SECOND(0.5123456)', '=SECOND(0)', '=SECOND(0.999999)']])
...
const engine = await HyperFormula.buildFromArray([['=SECOND("14:42:59")', '=SECOND("01/01/1900 03:01:02am")', '=SECOND("31/12/2018")']])
