...
const engine = await HyperFormula.buildFromArray([['=TIMEVALUE("foo")', '=TIMEVALUE(1)', '=TIMEVALUE(1, 2)', '=TIMEVALUE()']])
...
const engine = await HyperFormula.buildFromArray([['=TIMEVALUE("3:00pm")', '=TIMEVALUE("15:00")', '=TIMEVALUE("21:00:00")']])
  ...
  it('ignores date', async() => {
const engine = await HyperFormula.buildFromArray([['=TIMEVALUE("3:00pm")', '=TIMEVALUE("31/12/2018 3:00pm")']])
  ...
  it('rollover', async() => {
const engine = await HyperFormula.buildFromArray([['=TIMEVALUE("24:00")', '=TIMEVALUE("31/12/2018 24:00")']])
