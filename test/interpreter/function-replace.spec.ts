...
describe('Function REPLACE', () => {
  it('should take 4 parameters', async() => {
const engine = await HyperFormula.buildFromArray([
  ...
  it('should replace characters in text based on given position and number of chars', async() => {
const engine = await HyperFormula.buildFromArray([
  ...
  it('should insert text before position if number of chars is 0', async() => {
const engine = await HyperFormula.buildFromArray([
  ...
  it('should append new text if start position is greater than text length', async() => {
const engine = await HyperFormula.buildFromArray([
...
const engine = await HyperFormula.buildFromArray([
  ...
  it('should return #VALUE! if parameters out of range', async() => {
const engine = await HyperFormula.buildFromArray([
  ...
  it('should return value when arguments of wrong type', async() => {
const engine = await HyperFormula.buildFromArray([
