...
beforeEach(() => {
  ...
  HyperFormula.registerFunctionPlugin(TextPlugin)
  HyperFormula.registerFunctionPlugin(NumericAggregationPlugin)
  HyperFormula.registerFunctionPlugin(MedianPlugin)
  HyperFormula.registerFunctionPlugin(DatePlugin)
  HyperFormula.registerFunctionPlugin(BooleanPlugin)
  HyperFormula.registerFunctionPlugin(InformationPlugin)
  HyperFormula.registerFunctionPlugin(TrigonometryPlugin)
  HyperFormula.registerFunctionPlugin(CountUniquePlugin)
  HyperFormula.registerFunctionPlugin(SumprodPlugin)
  HyperFormula.registerFunctionPlugin(MatrixPlugin)
  HyperFormula.registerFunctionPlugin(ExpPlugin)
  HyperFormula.registerFunctionPlugin(AbsPlugin)
  HyperFormula.registerFunctionPlugin(DegreesPlugin)
  HyperFormula.registerFunctionPlugin(RadiansPlugin)
  HyperFormula.registerFunctionPlugin(RandomPlugin)
  HyperFormula.registerFunctionPlugin(VlookupPlugin)
  HyperFormula.registerFunctionPlugin(IsEvenPlugin)
  HyperFormula.registerFunctionPlugin(IsOddPlugin)
  HyperFormula.registerFunctionPlugin(RoundingPlugin)
  HyperFormula.registerFunctionPlugin(RadixConversionPlugin)
  HyperFormula.registerFunctionPlugin(LogarithmPlugin)
  HyperFormula.registerFunctionPlugin(BitwiseLogicOperationsPlugin)
  HyperFormula.registerFunctionPlugin(BitShiftPlugin)
  HyperFormula.registerFunctionPlugin(PowerPlugin)
  HyperFormula.registerFunctionPlugin(MathConstantsPlugin)
  HyperFormula.registerFunctionPlugin(SqrtPlugin)
  HyperFormula.registerFunctionPlugin(ModuloPlugin)
  HyperFormula.registerFunctionPlugin(DeltaPlugin)
  HyperFormula.registerFunctionPlugin(CharPlugin)
