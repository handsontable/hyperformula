import {buildConfig, EmptyValue, ExportedCellChange, HyperFormula, InvalidAddressError, NoSheetWithIdError} from '../../src'
...
describe('changing cell content', () => {
  ...
  it('returns change of numeric matrix', () => {
    ...
    const engine = HyperFormula.buildFromArray(sheet, buildConfig({matrixDetection: true, matrixDetectionThreshold: 1}))
...
describe('updating column index', () => {
  it('should update column index when changing simple value', () => {
    const engine = HyperFormula.buildFromArray([
      ['1', '2'],
      ['3', '15'],
    ], buildConfig({matrixDetection: false, vlookupThreshold: 1, useColumnIndex: true}))
  ...
  it('should update column index when changing value inside numeric matrix', () => {
    const engine = HyperFormula.buildFromArray([
      ['1', '2'],
      ['3', '15'],
    ], buildConfig({matrixDetection: true, matrixDetectionThreshold: 1, vlookupThreshold: 1, useColumnIndex: true}))
