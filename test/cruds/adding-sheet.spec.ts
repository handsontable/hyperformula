...
describe('add sheet to engine', () => {
  it('should add sheet to empty engine', async() => {
    const engine = await HyperFormula.buildEmpty()
  ...
  it('should add sheet to engine with one sheet', async() => {
  ...
  it('should be possible to fetch empty cell from newly added sheet', async() => {
    const engine = await HyperFormula.buildEmpty()
  ...
  it('should add sheet with translated sheet name', async() => {
    HyperFormula.registerLanguage('plPL', plPL)
    const engine = await HyperFormula.buildEmpty({ language: 'plPL' })
  ...
  it('should add sheet with given name', async() => {
    const engine = await HyperFormula.buildEmpty()
  ...
  it('cannot add another sheet with same lowercased name', async() => {
    const engine = await HyperFormula.buildEmpty()
    engine.addSheet('foo')
  ...
  it('should return given name', async() => {
    const engine = await HyperFormula.buildEmpty()
  ...
  it('should return autogenerated name', async() => {
    const engine = await HyperFormula.buildEmpty()
  ...
  it('should throw error when sheet name is already taken', async() => {
const engine = await HyperFormula.buildEmpty()
    engine.addSheet('bar')
