...
describe('Move columns', () => {
  ...
  it('should adjust reference when swapping formula with dependency ', () => {
    ...
    expect(extractReference(engine, adr('B2'))).toEqual(CellAddress.relative(undefined, -1, 0))
  })
  ...
  it('should adjust absolute references', () => {
    ...
    expect(extractReference(engine, adr('B1'))).toEqual(CellAddress.absolute(undefined, 0, 0))
    expect(extractReference(engine, adr('B2'))).toEqual(CellAddress.relative(undefined, -1, 0))
  })
