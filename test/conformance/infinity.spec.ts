...
describe('Quality assurance of operators', () => {
    ...
    it('EXP(1000000000) should thrown #NUM! error', () => { //pending for #196
        const engine = createEngine([
            [1000000000],
            ['=EXP(A1)']
        ]);
    ...
    it('1000^500 should thrown #NUM! error', () => { //pending for #196
        const engine = createEngine([
            ['=1000^500']
        ]);
    ...
    it('too small -1*10^309 should return #NUM!', () => { //pending for #196
        const engine = createEngine([
            ['=-1*10 ^309']
        ]);
    ...
    it('too big number should return #NUM!', () => { //pending for #196
        const engine = createEngine([
            [`=9.99*10 ^308`]
        ]);
