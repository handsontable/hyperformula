...
describe('Text arithmetic', () => {
  it('"Aaa", "Aaa" should be supported by all comparison operators', () => {
  ...
  it('"ąęćńóśżź", "ąęćńóśżź" should be supported by all comparison operators', () => {
    const engine = HyperFormula.buildFromArray([
  ...
  it('"Żółcią", "ąęćńóśżź" should be supported by all comparison operators', () => {
    const engine = HyperFormula.buildFromArray([
