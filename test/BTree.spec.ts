...
describe('BTree', () => {
  ...
  it('#deleteKey from node which is t-1 and has right >=t sibling', () => {
    const btree = new BTree(2)
    btree.addKey(1, 11)
    btree.addKey(2, 12)
    btree.addKey(3, 13)
    ...
    expect(btree._root.children![0].keys).toEqual([2])
    expect(btree._root.children![0].values).toEqual([12])
    expect(btree._root.children![1].shift).toEqual(0)
    expect(btree._root.children![1].keys).toEqual([4])
    expect(btree._root.children![1].values).toEqual([14])
  })

  it('#deleteKey from node which is t-1, has right t-1 sibling and left >=t sibling', () => {
    const btree = new BTree(2)
    btree.addKey(1, 11)
    btree.addKey(3, 13)
    btree.addKey(4, 15)
  ...
  it('#deleteKey from internal node, which has right child with >=t keys', () => {
    const btree = new BTree(2)
    btree.addKey(1, 11)
    btree.addKey(2, 12)
    btree.addKey(3, 13)
  ...
  it('#deleteKey from internal node, which has right child with >=t keys and right child is shifted', () => {
    const btree = new BTree(2)
    btree.addKey(1, 11)
    btree.addKey(2, 12)
    btree.addKey(3, 13)
  ...
  it('#deleteKey from internal node, which has right child with t-1 keys and left child with >=t keys', () => {
    const btree = new BTree(2)
    btree.addKey(1, 11)
    btree.addKey(3, 13)
    btree.addKey(4, 14)
  ...
  it('#deleteKey from internal node, which both left and right child are t-1', () => {
    const btree = new BTree(2)
    btree.addKey(1, 11)
    btree.addKey(2, 12)
    btree.addKey(3, 13)
