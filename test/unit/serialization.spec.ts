...
describe('serialization', () => {
  it('should not loose sheet information on serialization', () => {
    ...
    expect(engine1.getCellSerialized(adr('A1'))).toBe(1)
    expect(engine1.getCellValueFormat(adr('A1'))).toBeUndefined()
    expect(engine1.getCellValueDetailedType(adr('A1'))).toEqual(CellValueDetailedType.NUMBER_RAW)

    expect(engine1.getCellSerialized(adr('B1'))).toBe('2')
    expect(engine1.getCellValueFormat(adr('B1'))).toBeUndefined()
    expect(engine1.getCellValueDetailedType(adr('B1'))).toEqual(CellValueDetailedType.NUMBER_RAW)

    expect(engine1.getCellSerialized(adr('C1'))).toBe('foo')
    expect(engine1.getCellValueFormat(adr('C1'))).toBeUndefined()
    expect(engine1.getCellValueDetailedType(adr('C1'))).toEqual(CellValueDetailedType.STRING)

    expect(engine1.getCellSerialized(adr('D1'))).toBe(true)
    expect(engine1.getCellValueFormat(adr('D1'))).toBeUndefined()
    expect(engine1.getCellValueDetailedType(adr('D1'))).toEqual(CellValueDetailedType.BOOLEAN)

    expect(engine1.getCellSerialized(adr('E1'))).toBe('\'1')
    expect(engine1.getCellValueFormat(adr('E1'))).toBeUndefined()
    expect(engine1.getCellValueDetailedType(adr('E1'))).toEqual(CellValueDetailedType.STRING)

    expect(engine1.getCellSerialized(adr('F1'))).toBe('33$')
    expect(engine1.getCellValueFormat(adr('F1'))).toBe('$')
    expect(engine1.getCellValueDetailedType(adr('F1'))).toEqual(CellValueDetailedType.NUMBER_CURRENCY)

    expect(engine1.getCellSerialized(adr('G1'))).toBe('12/01/15')
    expect(engine1.getCellValueFormat(adr('G1'))).toBe('DD/MM/YY')
    expect(engine1.getCellValueDetailedType(adr('G1'))).toEqual(CellValueDetailedType.NUMBER_DATE)

    expect(engine1.getCellSerialized(adr('H1'))).toBe('1%')
    expect(engine1.getCellValueFormat(adr('H1'))).toBeUndefined()
    expect(engine1.getCellValueDetailedType(adr('H1'))).toEqual(CellValueDetailedType.NUMBER_PERCENT)

    expect(engine1.getCellSerialized(adr('I1'))).toBe('=FOO(')
    expect(engine1.getCellValueFormat(adr('I1'))).toBeUndefined()
    expect(engine1.getCellValueDetailedType(adr('I1'))).toEqual(CellValueDetailedType.ERROR)

    expect(engine1.getCellSerialized(adr('J1'))).toBe('#DIV/0!')
    expect(engine1.getCellValueFormat(adr('J1'))).toBeUndefined()
    ...
    expect(engine1.getCellValueFormat(adr('K1'))).toBe('Date()')
    ...
    expect(engine2.getCellSerialized(adr('A1'))).toBe(1)
    expect(engine2.getCellValueFormat(adr('A1'))).toBeUndefined()
    expect(engine2.getCellValueDetailedType(adr('A1'))).toEqual(CellValueDetailedType.NUMBER_RAW)

    expect(engine2.getCellSerialized(adr('B1'))).toBe('2')
    expect(engine2.getCellValueFormat(adr('B1'))).toBeUndefined()
    expect(engine2.getCellValueDetailedType(adr('B1'))).toEqual(CellValueDetailedType.NUMBER_RAW)

    expect(engine2.getCellSerialized(adr('C1'))).toBe('foo')
    expect(engine2.getCellValueFormat(adr('C1'))).toBeUndefined()
    expect(engine2.getCellValueDetailedType(adr('C1'))).toEqual(CellValueDetailedType.STRING)

    expect(engine2.getCellSerialized(adr('D1'))).toBe(true)
    expect(engine2.getCellValueFormat(adr('D1'))).toBeUndefined()
    expect(engine2.getCellValueDetailedType(adr('D1'))).toEqual(CellValueDetailedType.BOOLEAN)

    expect(engine2.getCellSerialized(adr('E1'))).toBe('\'1')
    expect(engine2.getCellValueFormat(adr('E1'))).toBeUndefined()
    expect(engine2.getCellValueDetailedType(adr('E1'))).toEqual(CellValueDetailedType.STRING)

    expect(engine2.getCellSerialized(adr('F1'))).toBe('33$')
    expect(engine2.getCellValueFormat(adr('F1'))).toBe('$')
    expect(engine2.getCellValueDetailedType(adr('F1'))).toEqual(CellValueDetailedType.NUMBER_CURRENCY)

    expect(engine2.getCellSerialized(adr('G1'))).toBe('12/01/15')
    expect(engine2.getCellValueFormat(adr('G1'))).toBe('DD/MM/YY')
  ...
  it('should return raw value for array formula spill cells', () => {
    ...
    expect(engine.getCellSerialized(adr('A2'))).toBe('=TRANSPOSE(A1:C1)')
  })
  ...
  it('should return raw value for array formula non-top-left cells', () => {
    ...
    expect(engine.getCellSerialized(adr('A3'))).toBe(2)
    expect(engine.getCellSerialized(adr('A4'))).toBe(3)
  })
})
