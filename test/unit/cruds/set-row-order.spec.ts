...
describe('swapping rows - checking if it is possible', () => {
  it('should validate numbers for negative rows', () => {
    ...
    expect(engine.isItPossibleToSwapRowIndexes(0, [[-1, 0]])).toBe(false)
    expect(() =>
  ...
  it('should validate sources for non-integer values', () => {
    ...
    expect(engine.isItPossibleToSwapRowIndexes(0, [[1, 1], [0.5, 0]])).toBe(false)
    expect(() =>
  ...
  it('should validate sources for values exceeding sheet height', () => {
    ...
    expect(engine.isItPossibleToSwapRowIndexes(0, [[1, 1], [3, 0]])).toBe(false)
    expect(() =>
  ...
  it('should validate sources to be unique', () => {
    ...
    expect(engine.isItPossibleToSwapRowIndexes(0, [[0, 0], [1, 1], [1, 2]])).toBe(false)
    expect(() =>
  ...
  it('should validate sources to be permutation of targets', () => {
    ...
    expect(engine.isItPossibleToSwapRowIndexes(0, [[0, 0], [1, 1], [2, 1]])).toBe(false)
    expect(() =>
  ...
  it('should check for matrices', () => {
    ...
    expect(engine.isItPossibleToSwapRowIndexes(0, [[0, 2], [1, 1], [2, 0]])).toBe(false)
    expect(() =>
  ...
  it('should check for matrices only in moved rows', () => {
    ...
    expect(engine.isItPossibleToSwapRowIndexes(0, [[0, 1], [1, 0], [2, 2]])).toBe(true)
    expect(() =>
...
describe('swapping rows should correctly work', () => {
  it('should work on static engine', () => {
    ...
    expect(engine.isItPossibleToSwapRowIndexes(0, [[0, 1], [1, 0]])).toBe(true)
  ...
  it('should work with more complicated permutations', () => {
    ...
    expect(engine.isItPossibleToSwapRowIndexes(0, [[0, 1], [1, 2], [2, 0]])).toBe(true)
  ...
  it('should not move values unnecessarily', () => {
    ...
    expect(engine.isItPossibleToSwapRowIndexes(0, [[0, 0], [1, 1]])).toBe(true)
...
describe('setting row order - checking if it is possible', () => {
  it('should check for length', () => {
    ...
    expect(engine.isItPossibleToSetRowOrder(0, [0])).toBe(false)
    expect(() =>
  ...
  it('should validate sources for non-integer values', () => {
    ...
    expect(engine.isItPossibleToSetRowOrder(0, [0, 0.5])).toBe(false)
    expect(() =>
  ...
  it('should validate for repeated values', () => {
    ...
    expect(engine.isItPossibleToSetRowOrder(0, [0, 1, 1])).toBe(false)
    expect(() =>
  ...
  it('should validate sources to be permutation of targets', () => {
    ...
    expect(engine.isItPossibleToSetRowOrder(0, [1, 2, 3])).toBe(false)
    expect(() =>
  ...
  it('should check for matrices', () => {
    ...
    expect(engine.isItPossibleToSetRowOrder(0, [2, 1, 0])).toBe(false)
    expect(() =>
  ...
  it('should check for matrices only in moved rows', () => {
    ...
    expect(engine.isItPossibleToSetRowOrder(0, [1, 0, 2])).toBe(true)
    expect(() =>
...
describe('reorder base case', () => {
  it('should work on static engine', () => {
    ...
    expect(engine.isItPossibleToSetRowOrder(0, [1, 0])).toBe(true)
  ...
  it('should work with more complicated permutations', () => {
    ...
    expect(engine.isItPossibleToSetRowOrder(0, [1, 2, 0])).toBe(true)
  ...
  it('should not move values unnecessarily', () => {
    ...
    expect(engine.isItPossibleToSetRowOrder(0, [0, 1])).toBe(true)
  ...
  it('should work with internal references', () => {
    ...
    expect(engine.isItPossibleToSetRowOrder(0, fillValues([1, 2, 0], 15))).toBe(true)
...
describe('reorder working with redo', () => {
  ...
  it('should work with external references', () => {
    ...
    expect(engine.isItPossibleToSetRowOrder(0, [1, 2, 0, 3])).toBe(true)
    engine.redo()
  ...
  it('should work with internal references', () => {
    ...
    expect(engine.isItPossibleToSetRowOrder(0, fillValues([1, 2, 0], 16))).toBe(true)
    engine.redo()
