...
import {SimpleRangeValue} from '../../src'
...
describe('ColumnIndex#find', () => {
  ...
  it('should find row number', () => {
    ...
    index.add(1, adr('A2'))
    const row = index.find(1, SimpleRangeValue.onlyRange(new AbsoluteCellRange(adr('A1'), adr('A3')), undefined!), { ordering: 'asc', ifNoMatch: 'returnNotFound' })
  ...
  it('should find the smallest row number for value if range not sorted', () => {
    ...
    index.add(1, adr('A4'))
    index.add(1, adr('A10'))
    const row = index.find(1, SimpleRangeValue.onlyRange(new AbsoluteCellRange(adr('A1'), adr('A20')), undefined!), { ordering: 'none', ifNoMatch: 'returnNotFound' })
  ...
  it('should find the largest row number for value if range sorted ascending', () => {
    ...
    index.add(1, adr('A4'))
    index.add(1, adr('A10'))
    const row = index.find(1, SimpleRangeValue.onlyRange(new AbsoluteCellRange(adr('A1'), adr('A20')), undefined!), { ordering: 'asc', ifNoMatch: 'returnNotFound' })
...
describe('ColumnIndex - lazy crud operations', () => {
...
describe('Arrays', () => {
  ...
  it('should remove values when replacing array with parsing error', () => {
    const engine = HyperFormula.buildFromArray([
      [1, 2, '=-A1:B1'],
    ], {useArrayArithmetic: true, useColumnIndex: true})
