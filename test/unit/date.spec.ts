...
const toNum = (val: unknown): number => {
  if (isNumeric(val)) return val.toNumber()
  if (typeof val === 'number') return val
  throw new Error(`Expected number or Numeric, got ${typeof val}`)
}
...
describe('Date helpers', () => {
  ...
  it('#dateNumberToMonthNumber should return proper month number', () => {
    ...
    expect(dateHelper.numberToSimpleDate(0).month).toBe(12)
    expect(dateHelper.numberToSimpleDate(2).month).toBe(1)
    expect(dateHelper.numberToSimpleDate(43465).month).toBe(12)
  })
  ...
  it('#stringToDateNumber - no time format', () => {
    ...
    expect(dateHelper.dateStringToDateNumber(' 31 12 2999 ')).toEqual(new DateNumber(401768, 'DD/MM/YYYY'))
    expect(dateHelper.dateStringToDateNumber('31  12 2999')).toEqual(new DateNumber(401768, 'DD/MM/YYYY'))
    expect(dateHelper.dateStringToDateNumber('16/08/1985 3:40')).toBeUndefined()
  })
  ...
  it('#stringToDateNumber - fraction of seconds', () => {
    ...
    expect(toNum(getRawValue(dateHelper.dateStringToDateNumber('00:00:00.1')))).toBeCloseTo(0.0000011574074074074074)
    expect(toNum(getRawValue(dateHelper.dateStringToDateNumber('00:00:00.01')))).toBeCloseTo(1.1574074074074073e-7)
    expect(toNum(getRawValue(dateHelper.dateStringToDateNumber('00:00:00.001')))).toBeCloseTo(0)
  })
  ...
  it('#stringToDateNumber am/pm', () => {
    ...
    expect(dateHelper.dateStringToDateNumber('13:00 am')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('13:00 pm')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('pm')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('02/02/2020 pm')).toBeUndefined()
  ...
  it('#stringToDateNumber - excel compatibility', () => {
    ...
    expect(dateHelper.dateStringToDateNumber('29/02/1900')).toBeUndefined()
  ...
  it('stringToDateNumber - other date formats', () => {
    ...
    expect(dateHelper.dateStringToDateNumber('12/31/99')).toBeUndefined()
    ...
    expect(dateHelper3.dateStringToDateNumber('1999/12/31')).toBeUndefined()
  ...
  it('#stringToDateNumber - tests expected to return undefined', () => {
    ...
    expect(dateHelper.dateStringToDateNumber('1/1/10000')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('5/29/1453')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('www')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('0')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('0/0/1999')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('13/13/2020')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('w8')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('www1')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('10/2020')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('12//31/2999')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('12/31/2999 0')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('12//31/2999 0:0')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('12/31/2999 0:0:0:0')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('12:00 12/31/2999')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber(' ')).toBeUndefined()
    expect(dateHelper.dateStringToDateNumber('')).toBeUndefined()
  })
})
...
describe('Date helpers, other zero date', () => {
  ...
  it('#dateNumberToMonthNumber should return proper month number, different zero date', () => {
    ...
    expect(dateHelper.numberToSimpleDate(0).month).toBe(6)
    expect(dateHelper.numberToSimpleDate(2).month).toBe(6)
    expect(dateHelper.numberToSimpleDate(43465).month).toBe(6)
  })
