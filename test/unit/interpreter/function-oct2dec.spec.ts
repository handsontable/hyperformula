...
describe('function OCT2DEC', () => {
  ...
  it('should work', () => {
    ...
    expect(engine.getCellValue(adr('A3'))).toBe(57)
    expect(engine.getCellValue(adr('A4'))).toBe(5349)
    expect(engine.getCellValue(adr('A5'))).toBe(1131893)
    expect(engine.getCellValue(adr('A6'))).toBe(175304620)
    expect(engine.getCellValue(adr('A7'))).toBe(-512)
    expect(engine.getCellValue(adr('A8'))).toBe(-478)
  ...
  it('should work for strings', () => {
    ...
    expect(engine.getCellValue(adr('A1'))).toBe(302)
  })
  ...
  it('should work for reference', () => {
    ...
    expect(engine.getCellValue(adr('A2'))).toBe(83)
  })
  ...
  it('should work only for 10 digits', () => {
    ...
    expect(engine.getCellValue(adr('A1'))).toEqualError(detailedError(ErrorType.NUM, ErrorMessage.NotOctal))
    expect(engine.getCellValue(adr('A2'))).toBe(-478)
  })
})
