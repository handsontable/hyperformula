...
describe('Function YEAR', () => {
  ...
  it('with numerical arguments', () => {
    ...
    expect(engine.getCellValue(adr('A1'))).toBe(1899)
    expect(engine.getCellValue(adr('B1'))).toBe(1900)
    expect(engine.getCellValue(adr('C1'))).toBe(2018)
  })
  ...
  it('use datenumber coercion for 1st argument', () => {
    ...
    expect(engine.getCellValue(adr('A1'))).toBe(1899)
    expect(engine.getCellValue(adr('A2'))).toBe(1899)
  })
