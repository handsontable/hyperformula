...
describe('Interpreter - SWITCH function', () => {
  ...
  it('Should work with precision', () => {
    // With precise decimal arithmetic, 1 !== 1.0000000000001, so no match is found
    const engine = HyperFormula.buildFromArray([
      ['1', '1.0000000001', '3', '1.0000000000001', '5'],
      ['=SWITCH(A1,B1,C1,D1,E1)']
    ])
    // No match found with precise arithmetic, returns #N/A
    expect(engine.getCellValue(adr('A2'))).toEqualError(detailedError(ErrorType.NA, ErrorMessage.NoDefault))
  })
