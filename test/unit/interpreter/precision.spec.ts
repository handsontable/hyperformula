...
describe('Precise comparisons (with arbitrary precision)', () => {
  // With precise decimal arithmetic, comparisons are mathematically exact
  // No epsilon tolerance is needed since we have exact decimal representation
  ...
  it('less-than', () => {
    ...
    // With exact arithmetic: 1 < 1.0000000001 is TRUE (mathematically correct)
    expect(engine.getCellValue(adr('A1'))).toBe(true)
    expect(engine.getCellValue(adr('B1'))).toBe(true)  // 1 < 1.00000000000005 is TRUE
    expect(engine.getCellValue(adr('A2'))).toBe(false) // 1.0000000001 < 1 is FALSE
    expect(engine.getCellValue(adr('B2'))).toBe(false)
    expect(engine.getCellValue(adr('A3'))).toBe(true)  // -1.0000000001 < -1 is TRUE
    expect(engine.getCellValue(adr('B3'))).toBe(true)
    expect(engine.getCellValue(adr('A4'))).toBe(false) // -1 < -1.0000000001 is FALSE
    expect(engine.getCellValue(adr('B4'))).toBe(false)
    expect(engine.getCellValue(adr('A5'))).toBe(true)  // 0 < 0.0000000001 is TRUE
    expect(engine.getCellValue(adr('B5'))).toBe(true)
    expect(engine.getCellValue(adr('A6'))).toBe(false) // 0.0000000001 < 0 is FALSE
    expect(engine.getCellValue(adr('B6'))).toBe(false)
    expect(engine.getCellValue(adr('A7'))).toBe(true)  // -0.0000000001 < 0 is TRUE
    expect(engine.getCellValue(adr('B7'))).toBe(true)
    expect(engine.getCellValue(adr('A8'))).toBe(false) // 0 < -0.0000000001 is FALSE
  ...
  it('greater-than', () => {
    ...
    expect(engine.getCellValue(adr('A1'))).toBe(false) // 1 > 1.0000000001 is FALSE
    expect(engine.getCellValue(adr('B1'))).toBe(false)
    expect(engine.getCellValue(adr('A2'))).toBe(true)  // 1.0000000001 > 1 is TRUE
    expect(engine.getCellValue(adr('B2'))).toBe(true)
    expect(engine.getCellValue(adr('A3'))).toBe(false) // -1.0000000001 > -1 is FALSE
    expect(engine.getCellValue(adr('B3'))).toBe(false)
    expect(engine.getCellValue(adr('A4'))).toBe(true)  // -1 > -1.0000000001 is TRUE
    expect(engine.getCellValue(adr('B4'))).toBe(true)
    expect(engine.getCellValue(adr('A5'))).toBe(false) // 0 > 0.0000000001 is FALSE
    expect(engine.getCellValue(adr('B5'))).toBe(false)
    expect(engine.getCellValue(adr('A6'))).toBe(true)  // 0.0000000001 > 0 is TRUE
    expect(engine.getCellValue(adr('B6'))).toBe(true)
    expect(engine.getCellValue(adr('A7'))).toBe(false) // -0.0000000001 > 0 is FALSE
    expect(engine.getCellValue(adr('B7'))).toBe(false)
    expect(engine.getCellValue(adr('A8'))).toBe(true)  // 0 > -0.0000000001 is TRUE
  ...
  it('less-equal', () => {
    ...
    expect(engine.getCellValue(adr('A1'))).toBe(true)  // 1 <= 1.0000000001 is TRUE
...
describe('Snap to zero', () => {
  ...
  it('minus', () => {
    ...
    // With precise decimal arithmetic, small differences are preserved exactly
    // Row 1: =1-1.0000000001 = -0.0000000001
    expect(engine.getCellValue(adr('A1'))).toBeCloseTo(-0.0000000001, 10)
    expect(engine.getCellValue(adr('B1'))).toBeCloseTo(-0.0000000000001, 13)
    // Row 2: =1.0000000001-1 = 0.0000000001
    expect(engine.getCellValue(adr('A2'))).toBeCloseTo(0.0000000001, 10)
    expect(engine.getCellValue(adr('B2'))).toBeCloseTo(0.0000000000001, 13)
    // Row 3: =-1.0000000001--1 = -1.0000000001+1 = -0.0000000001
    expect(engine.getCellValue(adr('A3'))).toBeCloseTo(-0.0000000001, 10)
    expect(engine.getCellValue(adr('B3'))).toBeCloseTo(-0.0000000000001, 13)
    // Row 4: =-1--1.0000000001 = -1+1.0000000001 = 0.0000000001
    expect(engine.getCellValue(adr('A4'))).toBeCloseTo(0.0000000001, 10)
    expect(engine.getCellValue(adr('B4'))).toBeCloseTo(0.0000000000001, 13)
    // Row 5: =0-0.0000000001 = -0.0000000001
    expect(engine.getCellValue(adr('A5'))).toBeCloseTo(-0.0000000001, 10)
    expect(engine.getCellValue(adr('B5'))).toBeCloseTo(-0.0000000000001, 13)
    // Row 6: =0.0000000001-0 = 0.0000000001
    expect(engine.getCellValue(adr('A6'))).toBeCloseTo(0.0000000001, 10)
    expect(engine.getCellValue(adr('B6'))).toBeCloseTo(0.0000000000001, 13)
    // Row 7: =-0.0000000001-0 = -0.0000000001
    expect(engine.getCellValue(adr('A7'))).toBeCloseTo(-0.0000000001, 10)
    expect(engine.getCellValue(adr('B7'))).toBeCloseTo(-0.0000000000001, 13)
    // Row 8: =0--0.0000000001 = 0+0.0000000001 = 0.0000000001
    expect(engine.getCellValue(adr('A8'))).toBeCloseTo(0.0000000001, 10)
    expect(engine.getCellValue(adr('B8'))).toBeCloseTo(0.0000000000001, 13)
  })
  ...
  it('plus', () => {
    ...
    // With precise decimal arithmetic, small differences are preserved exactly
    // Row 1: =1+-1.0000000001 = 1+(-1.0000000001) = -0.0000000001
    expect(engine.getCellValue(adr('A1'))).toBeCloseTo(-0.0000000001, 10)
    expect(engine.getCellValue(adr('B1'))).toBeCloseTo(-0.0000000000001, 13)
    // Row 2: =1.0000000001+-1 = 1.0000000001+(-1) = 0.0000000001
    expect(engine.getCellValue(adr('A2'))).toBeCloseTo(0.0000000001, 10)
    expect(engine.getCellValue(adr('B2'))).toBeCloseTo(0.0000000000001, 13)
    // Row 3: =-1.0000000001+1 = -0.0000000001
    expect(engine.getCellValue(adr('A3'))).toBeCloseTo(-0.0000000001, 10)
    expect(engine.getCellValue(adr('B3'))).toBeCloseTo(-0.0000000000001, 13)
    // Row 4: =-1+1.0000000001 = 0.0000000001
    expect(engine.getCellValue(adr('A4'))).toBeCloseTo(0.0000000001, 10)
    expect(engine.getCellValue(adr('B4'))).toBeCloseTo(0.0000000000001, 13)
    // Row 5: =0+-0.0000000001 = -0.0000000001
    expect(engine.getCellValue(adr('A5'))).toBeCloseTo(-0.0000000001, 10)
...
describe('tests', () => {
  ...
  it('addition of small numbers with smartRounding #2', () => {
    ...
    expect(engine.getCellValue(adr('C1'))).toBe(1.000123457) //as GS and E
  })
})
