...
describe('Date helpers', () => {
  ...
  it('#stringToDateNumber - tests expected to return not null, dates', () => {
    const dateHelper = new DateTimeHelper(new Config())
    expect(dateHelper.dateStringToDateNumber('16/08/1985')).toStrictEqual(new DateNumber(31275))
    expect(dateHelper.dateStringToDateNumber('15/01/2020')).toStrictEqual(new DateNumber(43845))
    expect(dateHelper.dateStringToDateNumber('29/02/2000')).toStrictEqual(new DateNumber(36585))
    expect(dateHelper.dateStringToDateNumber('31/12/2999')).toStrictEqual(new DateNumber(401768))
    expect(dateHelper.dateStringToDateNumber('31 12 2999')).toStrictEqual(new DateNumber(401768))
    expect(dateHelper.dateStringToDateNumber(' 31 12 2999 ')).toStrictEqual(new DateNumber(401768))
    expect(dateHelper.dateStringToDateNumber('31  12 2999')).toStrictEqual(new DateNumber(401768))
  })
  ...
  it('#stringToDateNumber - tests expected to return not null, times', () => {
    const dateHelper = new DateTimeHelper(new Config())
    expect(dateHelper.dateStringToDateNumber('00:00')).toStrictEqual(new TimeNumber(0))
    expect(dateHelper.dateStringToDateNumber('03:00')).toStrictEqual(new TimeNumber(0.125))
    expect(dateHelper.dateStringToDateNumber('24:00')).toStrictEqual(new TimeNumber(1))
    expect(dateHelper.dateStringToDateNumber('48:00')).toStrictEqual(new TimeNumber(2))
    expect(dateHelper.dateStringToDateNumber('00:01')).toStrictEqual(new TimeNumber(0.0006944444444444445))
    expect(dateHelper.dateStringToDateNumber('00:00:00')).toStrictEqual(new TimeNumber(0))
    expect(dateHelper.dateStringToDateNumber('00:00:00.001')).toStrictEqual(new TimeNumber(1.1574074074074076e-8))
    expect(dateHelper.dateStringToDateNumber('00:00:00.0001')).toStrictEqual(new TimeNumber(0))
    expect(dateHelper.dateStringToDateNumber('00:00:01')).toStrictEqual(new TimeNumber(0.000011574074074074073))
    expect(dateHelper.dateStringToDateNumber('00:179:60')).toStrictEqual(new TimeNumber(0.125))
  })
  ...
  it('#stringToDateNumber am/pm', () => {
    const dateHelper = new DateTimeHelper(new Config())
    expect(dateHelper.dateStringToDateNumber('03:00 am')).toStrictEqual(new TimeNumber(0.125))
    expect(dateHelper.dateStringToDateNumber('03:00 a')).toStrictEqual(new TimeNumber(0.125))
    expect(dateHelper.dateStringToDateNumber('03:00 pm')).toStrictEqual(new TimeNumber(0.625))
    expect(dateHelper.dateStringToDateNumber('12:00 pm')).toStrictEqual(new TimeNumber(0.5))
    expect(dateHelper.dateStringToDateNumber('12:00 p')).toStrictEqual(new TimeNumber(0.5))
    expect(dateHelper.dateStringToDateNumber('00:00 pm')).toStrictEqual(new TimeNumber(0.5))
    expect(dateHelper.dateStringToDateNumber('12:59 pm')).toStrictEqual(new TimeNumber(0.5409722222222222))
    expect(dateHelper.dateStringToDateNumber('12:00 am')).toStrictEqual(new TimeNumber(0.0))
    expect(dateHelper.dateStringToDateNumber('00:00 am')).toStrictEqual(new TimeNumber(0.0))
    expect(dateHelper.dateStringToDateNumber('12:59 am')).toStrictEqual(new TimeNumber(0.04097222222222222))
    ...
    expect(dateHelper.dateStringToDateNumber('02/02/2020 12:00pm')).toStrictEqual(new DateTimeNumber(43863.5))
    expect(dateHelper.dateStringToDateNumber('02/02/2020 12:9999pm')).toStrictEqual(new DateTimeNumber(43870.44375))
  })

  it('#stringToDateNumber - tests expected to return not null, dates + times', () => {
    const dateHelper = new DateTimeHelper(new Config())
    expect(dateHelper.dateStringToDateNumber('16/08/1985 03:40')).toStrictEqual(new DateTimeNumber(31275.152777777777))
    expect(dateHelper.dateStringToDateNumber(' 31 12 2999 00:00:00 ')).toStrictEqual(new DateTimeNumber(401768))
  })
  ...
  it('#stringToDateNumber - excel compatibility', () => {
    ...
    expect(dateHelper2.dateStringToDateNumber('29/02/1900')).toStrictEqual(new DateNumber(61))
  })

  it('stringToDateNumber - 00 year parsing', () => {
    const dateHelper = new DateTimeHelper(new Config())
    expect(dateHelper.dateStringToDateNumber('16/08/85')).toStrictEqual(new DateNumber(31275))
    expect(dateHelper.dateStringToDateNumber('15/01/20')).toStrictEqual(new DateNumber(43845))
    expect(dateHelper.dateStringToDateNumber('29/02/00')).toStrictEqual(new DateNumber(36585))
    expect(dateHelper.dateStringToDateNumber('31/12/99')).toStrictEqual(new DateNumber(36525))
    const dateHelper1 = new DateTimeHelper(new Config({nullYear: 0}))
    expect(dateHelper1.dateStringToDateNumber('15/01/20')).toStrictEqual(new DateNumber(7320))
    const dateHelper2 = new DateTimeHelper(new Config({nullYear: 100}))
    expect(dateHelper2.dateStringToDateNumber('31/12/99')).toStrictEqual(new DateNumber(73050))
  })
  ...
  it('stringToDateNumber - other date formats', () => {
    ...
    expect(dateHelper1.dateStringToDateNumber('99/12/31')).toStrictEqual(new DateNumber(36525))
    const dateHelper2 = new DateTimeHelper(new Config({dateFormats : ['MM/DD/YY', 'YY/MM/DD']}))
    expect(dateHelper2.dateStringToDateNumber('99/12/31')).toStrictEqual(new DateNumber(36525))
    ...
    expect(dateHelper4.dateStringToDateNumber('1999/12/31')).toStrictEqual(new DateNumber(36525))
    const dateHelper5 = new DateTimeHelper(new Config({dateFormats : ['MM/YYYY/DD']}))
    expect(dateHelper5.dateStringToDateNumber('12/1999/31')).toStrictEqual(new DateNumber(36525))
    const dateHelper6 = new DateTimeHelper(new Config({dateFormats : ['DD/YYYY/MM']}))
    expect(dateHelper6.dateStringToDateNumber('31/1999/12')).toStrictEqual(new DateNumber(36525))
    const dateHelper7 = new DateTimeHelper(new Config({dateFormats : ['DD/MM/YYYY']}))
    expect(dateHelper7.dateStringToDateNumber('31/12/1999')).toStrictEqual(new DateNumber(36525))
    const dateHelper8 = new DateTimeHelper(new Config({dateFormats : ['YY/DD/MM']}))
    expect(dateHelper8.dateStringToDateNumber('99/31/12')).toStrictEqual(new DateNumber(36525))
    const dateHelper9 = new DateTimeHelper(new Config({dateFormats : ['MM/YY/DD']}))
    expect(dateHelper9.dateStringToDateNumber('12/99/31')).toStrictEqual(new DateNumber(36525))
    const dateHelper10 = new DateTimeHelper(new Config({dateFormats : ['DD/MM/YY']}))
    expect(dateHelper10.dateStringToDateNumber('31/12/99')).toStrictEqual(new DateNumber(36525))
    const dateHelper11 = new DateTimeHelper(new Config({dateFormats : ['DD/YY/MM']}))
    expect(dateHelper11.dateStringToDateNumber('31/99/12')).toStrictEqual(new DateNumber(36525))
  })

  it('stringToDateNumber - other time formats', () => {
    const dateHelper = new DateTimeHelper(new Config({timeFormats : ['mm:hh']}))
    expect(dateHelper.dateStringToDateNumber('60:02')).toStrictEqual(new TimeNumber(0.125))
  })
...
describe('Date helpers, other zero date', () => {
  ...
  it('#stringToDateNumber - tests expected to return not null, different zero date', () => {
    const dateHelper = new DateTimeHelper(new Config({nullDate: {year: 1950, month: 6, day: 15}}))
    expect(dateHelper.dateStringToDateNumber('16/08/1985')).toStrictEqual(new DateNumber(12846))
    expect(dateHelper.dateStringToDateNumber('15/01/2020')).toStrictEqual(new DateNumber(25416))
    expect(dateHelper.dateStringToDateNumber('29/02/2000')).toStrictEqual(new DateNumber(18156))
    expect(dateHelper.dateStringToDateNumber('31/12/2999')).toStrictEqual(new DateNumber(383339))
  })
})
...
describe('Custom date parsing', () => {
  ...
  it( 'moment-based custom parsing', () => {
    ...
    const dateHelper = new DateTimeHelper(config)
    expect(dateHelper.dateStringToDateNumber('31st Jan 00')).toStrictEqual(new DateNumber(36556))
    expect(dateHelper.dateStringToDateNumber('365 1900')).toStrictEqual(new DateNumber(366))
  })
})
