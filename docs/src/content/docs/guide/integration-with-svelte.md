...
- [Configuration options](/docs/guide/configuration-options) — full list of `buildFromArray` / `buildEmpty` options
- [Basic operations](/docs/guide/basic-operations) — CRUD on cells, rows, columns, sheets
- [Advanced usage](/docs/guide/advanced-usage) — multi-sheet workbooks, named expressions
- [Custom functions](/docs/guide/custom-functions) — register your own formulas
