...
HyperFormula has no built-in file import functionality. But its [factory methods](/docs/api/classes/hyperformula#factories) use standard JavaScript data types, for easy integration with any way of importing data.
