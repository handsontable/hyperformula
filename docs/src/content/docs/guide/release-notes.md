...
- Fixed an issue where the [`simpleCellAddressFromString()`](/docs/api/classes/hyperformula#simplecelladdressfromstring) method was crashing when called with a non-ASCII character in an unquoted sheet name. [#1312](https://github.com/handsontable/hyperformula/issues/1312)
...
- Optimized the [`updateConfig()`](/docs/api/classes/hyperformula#updateconfig) method to rebuild HyperFormula only when
...
- Exported the [`CellError`](/docs/api/classes/cellerror) class as a public
  API. [#1232](https://github.com/handsontable/hyperformula/issues/1232)
- Exported the [`SimpleRangeValue`](/docs/api/classes/simplerangevalue) class as a public
...
- Fixed an issue where the order of items returned by [`removeColumns()`](/docs/api/classes/hyperformula#removecolumns)
...
- Exported the [`ArraySize`](/docs/api/classes/arraysize) class as a public
  API. [#843](https://github.com/handsontable/hyperformula/issues/843)
- Renamed an internal interface from `ArgumentTypes`
  to [`FunctionArgumentType`](/docs/api/classes/hyperformulans#functionargumenttype), and exported it as a public
...
- Changed the rounding strategy of the default time-parsing function to be independent of
  the [`timeFormats`](/docs/api/interfaces/configparams#timeformats) configuration option. Now, time values are always
...
- Added a new configuration option, [`ignoreWhiteSpace`](/docs/api/interfaces/configparams#ignorewhitespace), which allows
...
- Added a new static property: [`HyperFormula.defaultConfig`](/docs/api/classes/hyperformula#defaultconfig).
  [#822](https://github.com/handsontable/hyperformula/issues/822)
- The [`getFillRangeData()`](/docs/api/classes/hyperformula#getfillrangedata)
...
- Fixed the handling of Unicode characters and non-letter characters in the [PROPER](/docs/guide/built-in-functions#text)
...
- Fixed the [SUMPRODUCT](/docs/guide/built-in-functions#math-and-trigonometry)
