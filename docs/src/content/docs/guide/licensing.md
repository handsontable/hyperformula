...
To learn how to use the GPLv3 license, see the [License key](/docs/guide/license-key#gplv3-license) page.
...
To find out how to enter a license key, see the [License key](/docs/guide/license-key) page.