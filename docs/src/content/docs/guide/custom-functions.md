...
functions ([built-in](/docs/guide/built-in-functions#list-of-available-functions) and
custom).
...
- Handles the [array arithmetic mode](/docs/guide/arrays#array-arithmetic-mode).
- Performs
  [function vectorization](/docs/guide/arrays#passing-arrays-to-scalar-functions-vectorization).
- Performs [argument broadcasting](/docs/guide/arrays#broadcasting).
...
Use the
[`registerFunctionPlugin()`](/docs/api/classes/hyperformula#registerfunctionplugin)
method:
...
[`SimpleRangeValue` class](/docs/api/classes/simplerangevalue):
...
A function can return multiple values in the form of an [array](/docs/guide/arrays). To
do that, use [`SimpleRangeValue` class](/docs/api/classes/simplerangevalue):
...
[`ArraySize` class](/docs/api/classes/arraysize).
...
[`CellError` class](/docs/api/classes/cellerror) with the relevant
[error type](/docs/guide/types-of-errors). Errors are localized according to your
[language settings](/docs/guide/localizing-functions).
...
:::tip
All HyperFormula [error types](/docs/guide/types-of-errors) support optional
...
| `isVolatile`                        | Boolean | `true`: the function is [volatile](/docs/guide/volatile-functions).<br/>Default: `false`                                                                                                                                                               |
...
| `enableArrayArithmeticForArguments`                     | Boolean | `true`: the function enables the [array arithmetic mode](/docs/guide/arrays) in its arguments and nested expressions.<br/>Default: `false`                                                                                                             |
| `vectorizationForbidden`            | Boolean | `true`: the function will never get [vectorized](/docs/guide/arrays#passing-arrays-to-scalar-functions-vectorization).<br/>Default: `false`                                                                                                            |
...
[register and set the language](/docs/guide/localizing-functions).
:::
