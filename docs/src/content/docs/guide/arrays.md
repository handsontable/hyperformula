...
- The [`arrayColumnSeparator`](/docs/api/classes/config#arraycolumnseparator) (default: `,`)
- The [`arrayRowSeparator`](/docs/api/classes/config#arrayrowseparator) (default: `;`)
...
* In your HyperFormula [configuration](/docs/api/interfaces/configparams#usearrayarithmetic), set the `useArrayArithmetic` option to `true`.
