...
In Google Sheets, date and time formats depend on the spreadsheet's configured locale and are [shared across all users](https://support.google.com/docs/answer/58515), whereas in HyperFormula you can [set them up freely](i18n-overview.md#date-and-time-formats).
