...
* All arrays passed as parameters to the FILTER function must have the same dimensions and one of the dimensions must be 1 i.e. it must be either a single row of data or a single column.
