...
| Cell references inside inline arrays               | ={A1, A2}                                                                 | Array value calculated but not updated on cell values changes.                                                                                                                                                                                                                                         | Array value calculated and updated on cell values changes.                                                                        | ERROR - invalid array                                    |
