...
| Enabling array arithmetic                  | =ARRAYFORMULA(A2:A5*B2:B5)                             | The ARRAYFORMULA function enables array arithmetic. | Same as HyperFormula.                                                                    | Array arithmetic is enabled by default.                                            |
