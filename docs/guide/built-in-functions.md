...
| IFS         | Evaluates multiple logical tests and returns a value that corresponds to the first true condition.                               | IFS(Logicalvalue1, Value1[, Logicalvalue2, Value2[..., Logicalvalue_n, Value_n]]) |
