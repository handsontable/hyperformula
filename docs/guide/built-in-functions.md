...
| SUBTOTAL        | Computes aggregation using function specified by number.                                                      | SUBTOTAL(Function, Number1, Number2, ...)                                                   |
...
| Function ID     | Description                                                                                               | Syntax                                                                                      |
| :-------------- | :-------------------------------------------------------------------------------------------------------- |:--------------------------------------------------------------------------------------------|
| AVEDEV          | Returns the average deviation of the arguments.                                                           | AVEDEV(Number1, Number2, ...)                                                       |
...
| DEVSQ           | Returns sum of squared deviations.                                                                        | DEVSQ(Number1, Number2, ...)                                                                |
...
| GEOMEAN         | Returns the geometric average.                                                                            | GEOMEAN(Number1, Number2, ...)                                                              |
| HARMEAN         | Returns the harmonic average.                                                                             | HARMEAN(Number1, Number2, ...)                                                              |
...
| MEDIAN          | Returns the median of a set of numbers.                                                                   | MEDIAN(Number1, Number2, ...)                                                       |
...
| SKEW            | Returns skeweness of a sample.                                                                            | SKEW(Number1, Number2, ...)                                                                 |
| SKEW.P          | Returns skeweness of a population.                                                                        | SKEW.P(Number1, Number2, ...)                                                        |
| SKEWP           | Returns skeweness of a population.                                                                        | SKEWP(Number1, Number2, ...)                                                        |
