...
| INDIRECT reference forms                            | `=INDIRECT("B1:C1")`<br><br>`=INDIRECT("R1C2", FALSE())`                 | Resolves one same-sheet A1 cell. Ranges, sheet-qualified references, names, and R1C1 notation return `#REF!`. See [known limitations](known-limitations.md#indirect-function).                                                                                                                                                                       | Can reference a range, another sheet, or an R1C1 address.                                                                      | Same as Google Sheets.                                                                                                         |
