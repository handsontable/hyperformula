...
|:-------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Number precision (precise mode)            | Up to 1e+9 significant digits using [decimal.js](https://mikemcl.github.io/decimal.js/). Configurable via [numericDigits](../api/interfaces/configparams.html#precisionnumberdigits) (default: 34). See [Numeric precision guide](numeric-precision.md). |
| Number precision (native mode)             | ~15 significant digits (with all the [limitations of the JavaScript floating-point arithmetics](https://patrickkarsh.medium.com/why-math-is-hard-in-javascript-floating-point-precision-in-javascript-41706aa7a89d)). |
