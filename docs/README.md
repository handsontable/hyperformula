...
Which files are generated by what, and why the generator fails the build rather than skipping: [`dev-docs/BUILD.md`](../dev-docs/BUILD.md) and [`dev-docs/FUNCTION-CATALOGUE.md`](../dev-docs/FUNCTION-CATALOGUE.md).
