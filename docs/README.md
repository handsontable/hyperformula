...
Writing style and guide structure: [`DOCS_CONTENT_GUIDE.md`](../DOCS_CONTENT_GUIDE.md). When documentation is required, what must not be duplicated, and how to describe behaviour that deviates from Excel: [`dev-docs/DOC-STANDARDS.md`](../dev-docs/DOC-STANDARDS.md).
