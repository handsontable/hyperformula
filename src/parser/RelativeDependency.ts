...
export type RelativeDependency = AddressDependency | RangeDependency | NamedExpressionDependency | NamedExpressionRangeDependency
...
export class NamedExpressionRangeDependency {
  constructor(
