...
export const LOGICAL_DOCS: Record<string, FunctionDoc> = {
  ...
  IF: {
    ...
    parameters: [
      {name: 'Test', description: 'The logical expression or value to evaluate.'},
      {name: 'Then_value', description: 'The value returned when Test evaluates to TRUE.'},
      {name: 'Otherwise_value', description: 'The value returned when Test evaluates to FALSE. When omitted, FALSE is returned instead.'},
    ],
  ...
  IFS: {
    ...
    parameters: [
      {name: 'Condition1', description: 'A logical test to evaluate. Further condition/value pairs can be passed as additional arguments and are checked in order.'},
      {name: 'Value1', description: 'The value returned when the preceding condition is the first one to evaluate to TRUE. Further condition/value pairs can be passed as additional arguments.'},
    ],
  ...
  SWITCH: {
    ...
    parameters: [
      {name: 'Expression1', description: 'The expression or value compared against the candidate values that follow.'},
      {name: 'Value1', description: 'The first candidate value compared to Expression1.'},
      {name: 'Expression2', description: 'The value returned when the preceding candidate matches Expression1. Further Value/Expression pairs can be passed as additional arguments, and a final unpaired argument is returned as the default when no candidate matches.'},
    ],
