...
export const LOOKUP_AND_REFERENCE_DOCS: Record<string, FunctionDoc> = {
  ...
  HLOOKUP: {
    ...
    parameters: [
      ...
      {name: 'Sort_Order', description: 'TRUE (default) performs an approximate match against ascending-sorted data, FALSE performs an exact match.'},
    ],
  ...
  MATCH: {
    ...
    parameters: [
      ...
      {name: 'MatchType', description: '1 (default) finds the largest value less than or equal to Searchcriterion in ascending-sorted data, -1 finds the smallest value greater than or equal to it in descending-sorted data, and 0 finds an exact match.'},
    ],
