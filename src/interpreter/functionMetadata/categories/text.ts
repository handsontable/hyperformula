...
export const TEXT_DOCS: Record<string, FunctionDoc> = {
  ...
  EXACT: {
    ...
    parameters: [
      {name: 'Text1', description: 'The first text value to compare.'},
      {name: 'Text2', description: 'The second text value to compare, matched case-sensitively against Text1.'},
    ],
  ...
  FIND: {
    ...
    parameters: [
      {name: 'Text1', description: 'The text to search for. The search is case-sensitive.'},
      {name: 'Text2', description: 'The text to search within.'},
      {name: 'Number', description: 'The 1-based character position in Text2 at which to start searching. Defaults to 1.'},
    ],
  ...
  LEFT: {
    ...
    parameters: [
      {name: 'Text', description: 'The text to extract characters from.'},
      {name: 'Number', description: 'The number of characters to extract, counting from the left. Defaults to 1.'},
    ],
  ...
  MID: {
    ...
    parameters: [
      {name: 'Text', description: 'The text to extract a substring from.'},
      {name: 'Start_position', description: 'The 1-based position of the first character to extract.'},
      {name: 'Length', description: 'The number of characters to extract, starting at Start_position.'},
    ],
  ...
  REPLACE: {
    ...
    parameters: [
      {name: 'Text', description: 'The text in which characters are replaced.'},
      {name: 'Start_position', description: 'The 1-based position of the first character to replace.'},
      {name: 'Length', description: 'The number of characters to replace, starting at Start_position.'},
      {name: 'New_text', description: 'The text that replaces the removed characters.'},
    ],
  ...
  REPT: {
    ...
    parameters: [
      ...
      {name: 'Number', description: 'The number of times to repeat Text.'},
    ],
  ...
  RIGHT: {
    ...
    parameters: [
      {name: 'Text', description: 'The text to extract characters from.'},
      {name: 'Number', description: 'The number of characters to extract, counting from the right. Defaults to 1.'},
    ],
  ...
  SEARCH: {
    ...
    parameters: [
      {name: 'Search_string', description: 'The text to search for. The search is case-insensitive and may contain "?" and "*" wildcards.'},
      {name: 'Text', description: 'The text to search within.'},
      {name: 'Start_position', description: 'The 1-based character position in Text at which to start searching. Defaults to 1.'},
    ],
  ...
  SPLIT: {
    ...
    parameters: [
      {name: 'Text', description: 'The text to split on the space character.'},
      {name: 'Index', description: 'The zero-based position of the chunk to return after splitting.'},
    ],
  ...
  SUBSTITUTE: {
    ...
    parameters: [
      {name: 'Text', description: 'The text in which occurrences of Old_text are replaced.'},
      {name: 'Old_text', description: 'The text to search for and replace.'},
      {name: 'New_text', description: 'The text that replaces each matched occurrence of Old_text.'},
      {name: 'Occurrence', description: 'The 1-based occurrence of Old_text to replace. When omitted, every occurrence is replaced.'},
    ],
  ...
  TEXT: {
    ...
    parameters: [
      {name: 'Number', description: 'The number or date serial value to format as text.'},
      {name: 'Format', description: 'The format pattern used to render Number as text, e.g. "0.00" or "YYYY-MM-DD".'},
    ],
  ...
  TEXTJOIN: {
    ...
    parameters: [
      {name: 'Delimiter', description: 'The text (or range/array of texts, cycled through the gaps) inserted between joined values.'},
