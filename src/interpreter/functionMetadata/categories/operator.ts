...
export const OPERATOR_DOCS: Record<string, FunctionDoc> = {
  'HF.ADD': {
    ...
    parameters: [
      {name: 'Number1', description: 'The first number in the addition.'},
      {name: 'Number2', description: 'The second number, added to Number1.'},
    ],
  ...
  'HF.CONCAT': {
    ...
    parameters: [
      {name: 'String1', description: 'The first string in the concatenation.'},
      {name: 'String2', description: 'The second string, appended to the end of String1.'},
    ],
  ...
  'HF.DIVIDE': {
    ...
    parameters: [
      {name: 'Number1', description: 'The dividend, i.e. the number being divided.'},
      {name: 'Number2', description: 'The divisor. Dividing by 0 returns the #DIV/0! error.'},
    ],
  ...
  'HF.EQ': {
    ...
    parameters: [
      {name: 'Value1', description: 'The first value to compare.'},
      {name: 'Value2', description: 'The second value, compared with Value1; the result is TRUE when the two values are equal.'},
    ],
  ...
  'HF.GT': {
    ...
    parameters: [
      {name: 'Value1', description: 'The value tested against Value2.'},
      {name: 'Value2', description: 'The value that Value1 is compared against; the result is TRUE when Value1 is greater than Value2.'},
    ],
  ...
  'HF.GTE': {
    ...
    parameters: [
      {name: 'Value1', description: 'The value tested against Value2.'},
      {name: 'Value2', description: 'The value that Value1 is compared against; the result is TRUE when Value1 is greater than or equal to Value2.'},
    ],
  ...
  'HF.LT': {
    ...
    parameters: [
      {name: 'Value1', description: 'The value tested against Value2.'},
      {name: 'Value2', description: 'The value that Value1 is compared against; the result is TRUE when Value1 is less than Value2.'},
    ],
  ...
  'HF.LTE': {
    ...
    parameters: [
      {name: 'Value1', description: 'The value tested against Value2.'},
      {name: 'Value2', description: 'The value that Value1 is compared against; the result is TRUE when Value1 is less than or equal to Value2.'},
    ],
  ...
  'HF.MINUS': {
    ...
    parameters: [
      {name: 'Number1', description: 'The number to subtract from.'},
      {name: 'Number2', description: 'The number subtracted from Number1.'},
    ],
  ...
  'HF.MULTIPLY': {
    ...
    parameters: [
      {name: 'Number1', description: 'The first factor in the multiplication.'},
      {name: 'Number2', description: 'The second factor, multiplied by Number1.'},
    ],
  ...
  'HF.NE': {
    ...
    parameters: [
      {name: 'Value1', description: 'The first value to compare.'},
      {name: 'Value2', description: 'The second value, compared with Value1; the result is TRUE when the two values are not equal.'},
    ],
  ...
  'HF.POW': {
    ...
    parameters: [
      {name: 'Number1', description: 'The base number.'},
      {name: 'Number2', description: 'The exponent that Number1 is raised to.'},
    ],
