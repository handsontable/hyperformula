...
export class TextPlugin extends FunctionPlugin implements FunctionPluginTypecheck<TextPlugin>{
   ...
   * @param state
   */
  public concatenate(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
   ...
   * @param state
   */
  public split(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public len(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
    return this.runFunction(ast.args, state, this.metadata('LEN'), (arg: string) => {
      return arg.length
    })
  }

  public lower(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
    return this.runFunction(ast.args, state, this.metadata('LOWER'), (arg: string) => {
      return arg.toLowerCase()
    })
  }

  public trim(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
    return this.runFunction(ast.args, state, this.metadata('TRIM'), (arg: string) => {
      return arg.replace(/^ +| +$/g, '').replace(/ +/g, ' ')
    })
  }

  public proper(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public clean(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public exact(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
    return this.runFunction(ast.args, state, this.metadata('EXACT'), (left: string, right: string) => {
      return left === right
    })
  }

  public rept(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public right(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public left(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public mid(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public replace(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public search(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public substitute(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public find(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public t(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public upper(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
