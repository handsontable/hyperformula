...
import {InternalScalarValue, AsyncInterpreterValue, RawNoErrorScalarValue} from '../InterpreterValue'
...
export class LookupPlugin extends FunctionPlugin implements FunctionPluginTypecheck<LookupPlugin>{
   ...
   * @param state
   */
  public vlookup(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
   ...
   */
  public hlookup(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public match(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
