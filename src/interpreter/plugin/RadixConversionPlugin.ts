...
export class RadixConversionPlugin extends FunctionPlugin implements FunctionPluginTypecheck<RadixConversionPlugin>{
  ...
  public bin2oct(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public bin2hex(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public oct2dec(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public oct2bin(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public oct2hex(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
 ...
 public hex2dec(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public hex2bin(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public hex2oct(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public base(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
    return this.runFunction(ast.args, state, this.metadata('BASE'), decimalToBaseWithMinimumPadding)
  }

  public decimal(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
