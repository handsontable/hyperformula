...
import {getRawValue, AsyncInterpreterValue, RawScalarValue} from '../InterpreterValue'
...
export class RomanPlugin extends FunctionPlugin implements FunctionPluginTypecheck<RomanPlugin>{
  ...
  public roman(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
  ...
  public arabic(ast: ProcedureAst, state: InterpreterState): AsyncInterpreterValue {
