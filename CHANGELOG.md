...
- Added agent-friendly documentation: per-page `.md` companions, a Copy-Markdown button, an `llms.txt` index, and a coding-agent setup guide. [#1703](https://github.com/handsontable/hyperformula/pull/1703)
